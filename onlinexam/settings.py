...
SECRET_KEY = "django-insecure-7e1bd*%^p171ynqmu9gsr)f%=tes(=tda8c4o%mckzqad0d!qi"
...
EMAIL_RECEIVING_USER = ['pawankumariit21@gmail.com'] # email on which you will receive messages sent from website
